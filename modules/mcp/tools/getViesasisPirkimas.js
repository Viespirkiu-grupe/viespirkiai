...
Dalyviai ir pasiūlymų kainos (tik nauja CVP IS, t.y. kai pirkimas turi PPA failą): šie duomenys struktūrizuotai pasiekiami per execute_query, NE per get_failas_tekstas (PPA yra .xlsx, todėl teksto/OCR puslapiai tušti). Įėjimo taškas — ppa."ataskaitos" (jungtys: "failasId"→failai.id, "pirkimoNumeris"→pirkimo numeris). Iš ppa."ataskaitos".id → "ataskaitaId" pasiekiamos: ppa."dalyviai" (dalyviai su kodais), ppa."atmestiPasiulymai" (atmesti pasiūlymai su kainomis), ppa."pasiulymuEile" (pasiūlymų eilė su kainomis), ppa."ataskaituSutartys" (sutarčių sumos ir tiekėjai). Ataskaitos enumų "...Id" laukai jungiami su atitinkamomis ppa schemos žodynų lentelėmis per jų id; v_dalyviai pirkimo būdą jau grąžina tekstu. Tikslius stulpelius žiūrėk per get_schema(table). Seni pirkimai (CVPP) PPA neturi — dalyvių duomenys ten nepasiekiami.`;
