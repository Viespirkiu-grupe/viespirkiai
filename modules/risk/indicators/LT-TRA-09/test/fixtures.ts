...
// electronicProcurement scenarios — Subject.procurement.procedureOutcome,
...
// electronicProcurement matters to this indicator; the other fields are
// carried unused, the same way LT-TRA-08's fixtures do for their own unused
// fields.
export function procedureOutcome(electronicProcurement: boolean | null): ProcurementProcedureOutcome {
    return {
