...
As with LT-COM-01, `parameters.ts` ships with `scope: {}`, applying to every `pirkimoBudas`; narrowing is the same
open question noted in [`LT-COM-01/README.md`](../LT-COM-01/README.md). `lifecycle: 'shadow'` until that is
resolved.
