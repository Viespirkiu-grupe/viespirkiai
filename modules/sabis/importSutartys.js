...
const scrapeFetch = createScraperFetch("sabis", { operation: "importSutartys" });
import { postgres } from "../../postgres/postgres.js";
import { log } from "../../utils/log.js";
import config from "../../utils/config.js";

const BASE = `${config.dataGovUrl}/datasets/gov/nbfc/viesojo_sektoriaus_saskaitos/Sutartys`;
const LIMIT = 5000;
