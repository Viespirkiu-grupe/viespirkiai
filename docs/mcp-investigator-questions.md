...
> *"These two companies bid against each other every time, but I suspect the same person controls both through a shell holding company."*
...
SELECT "jarKodas", "imonesVardas", vardas, pavarde,
       "irasoTipas", "registruotaLietuvoje", "yraJuridinisAsmuo"
FROM v_person_links
