...
|----------------------|--------------------------|---------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `OrganizationEntity` | `jarCsv`                 | `registravimoData` (100% filled)                                                      | `statusasNuo` (100% filled — "status since")                                     | `registravimoData` → `statusasNuo` = org lifespan, but only when `statusoKodas ≠ 0` (inactive). Active orgs have no closing date — treat as open-ended.                                               |
