...
/**
 * SVG path strings used as graph node icons.
 *
 * Sourced from Material UI Icons (https://fonts.google.com/icons) — the
 * comment beside each entry names the original icon (e.g. "Business",
 * "DomainAdd").  To replace one, copy the `d=` attribute from the
 * corresponding `material-icons` SVG; the viewBox is fixed at `0 0 24 24`.
 */
